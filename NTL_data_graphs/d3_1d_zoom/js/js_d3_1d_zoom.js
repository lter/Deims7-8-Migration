		...
		Drupal.behaviors.d3_1d_zoom = { 
			attach: function( context, settings ) {
				...
				$('.plotDiv').once().each(function() {
						...
						var numsamps = drupalSettings.d3_1d_zoom.numsamps; 
						var dates = drupalSettings.d3_1d_zoom.dates; 
						var datetype = drupalSettings.d3_1d_zoom.datetype; 
						var values = drupalSettings.d3_1d_zoom.values; 
						var units = drupalSettings.d3_1d_zoom.units; 
						var dataset = drupalSettings.d3_1d_zoom.dataset;
