/* 
*  Currently the geofield bounding box does not migrate automatically. Hence, the information
*  is converted to simple numbers here and imported as such.
*  Corresponding YML file: migrate_plus.migration.deims_csv_site.yml
*/
